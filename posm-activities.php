                    ...
                    <div class="td-breadcrumb-title-wrap">
                        ...
                        <div class="td-breadcrumb-list wow td-animetion-right" data-wow-duration="1.5s"
                            ...
                            <ul>
                                ...
                                <li><i class="fa-sharp fa-solid fa-angle-right fa-fw"></i></li>
                                <li class="pages">POSM Activities</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="td-feature-4-wrap text-center mb-50 wow fadeInUp" data-wow-duration="1.5s"
                        ...
                        <h2 class="td-section-title text-white mb-15">Our POSM Activities Process</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="td-about-2-list mb-30">
                            <ul>
                                <li>
                                    ...
                                    <span>Display Stands and Retail Units</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Gondola Design and Setup</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Custom POSM Solutions</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>In-store Branding Materials</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Retail Display Fabrication</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Logistics and Delivery Across KSA</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Installation and Setup Services</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s"
                                    ...
                                    <h2 class="accordion-header" id="order_one">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            What types of POSM materials do you provide?
                                    ...
                                    <div id="order__collapse_one" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body td-faq-details-para">
                                            <p>We provide display stands, gondolas, retail units, and customized POS materials for various industries.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s"
                                    ...
                                    <div id="order__collapse_two" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body td-faq-details-para">
                                            <p>Yes, we provide complete delivery and installation services across KSA.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s"
                                    ...
                                    <h2 class="accordion-header" id="order_three">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Can you create custom POSM designs?
                                            <span class="accordion-btn"></span>
                                        </button>
                                    </h2>
                                    <div id="order__collapse_three" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body td-faq-details-para">
                                            <p>Yes, we design customized POSM solutions based on your brand and retail requirements.
                                            </p>
                                        </div>
                                    </div>
                                </div>
