        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-9">
                    <div class="td-about-3-content-wrap ml-20 mb-15 wow fadeInRight" data-wow-duration="1.5s"
                        data-wow-delay="0.2s">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="td-counter-2-wrap ml-30 mb-30">
                        ...
                        <div class="td-counter-2-content">
                            ...
                            <span class="td-counter-2-subtitle">Clients</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="td-counter-2-wrap ml-30 mb-30">
                        ...
                        <div class="td-counter-2-content">
                            ...
                            <span class="td-counter-2-subtitle">Events</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="td-counter-2-wrap ml-30 mb-30">
                        ...
                        <div class="td-counter-2-content">
                            ...
                            <span class="td-counter-2-subtitle">Employees</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="td-feature-4-wrap text-center mb-50 wow fadeInUp" data-wow-duration="1.5s"
                        data-wow-delay="0.3s">
                        <span class="td-section-subtitle td-section-subtitle-2 mb-25">Who We Are</span>
                        <h2 class="td-section-title text-white mb-15">Where Ideas Meet Opportunities</h2>
                        <p class="text-white">Fath Creative is dedicated to delivering creative exhibition and
                            branding solutions that help businesses showcase their identity and grow in competitive
                            markets.</p>
                    </div>
                </div>
            </div>
