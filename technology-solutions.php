<?php 
$pageTitle = "Technology Solutions | Innovative Event Tech | Fath Creative";
$pageDescription = "Innovative tech-driven solutions for events and exhibitions. Enhance engagement with interactive displays, VR/AR, and digital experiences.";
$pageKeywords = "Event Technology Saudi Arabia, Interactive Exhibition Displays Riyadh, Digital Marketing Tech";
include('header.php'); 
?>
                    ...
                    <div class="col-lg-12">
                        <div class="td-breadcrumb-title-wrap">
                            <h2 class="td-breadcrumb-title mb-10 wow td-animetion-left" data-wow-duration="1.5s"
                                data-wow-delay="0.3s">Technology Solutions</h2>
                            <div class="td-breadcrumb-list wow td-animetion-right" data-wow-duration="1.5s"
                                ...
                                <ul>
                                    ...
                                    <li><i class="fa-sharp fa-solid fa-angle-right fa-fw"></i></li>
                                    <li class="pages">Technology Solutions</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="td-feature-4-wrap text-center mb-50 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.3s; animation-name: fadeInUp;">
                            <h2 class="td-section-title text-white mb-15">Our Development Approach</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="accordion" id="general_faqaccordion">
                                   ...
                                   <h2 class="accordion-header" id="order_one">
                                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#order__collapse_one" aria-expanded="false" aria-controls="order__collapse_one">
                                        Do you build custom e-commerce stores?
                                   ...
                                   <h2 class="accordion-header" id="order_two">
                                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#order__collapse_two" aria-expanded="false" aria-controls="order__collapse_two">
                                        Are your mobile apps available on iOS and Android?
                                         <span class="accordion-btn"></span>
                                      </button>
                                   </h2>
                                   ...
                                   <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s" style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.5s; animation-name: fadeInUp;">
                                        <h2 class="accordion-header" id="order_four">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#order__collapse_four" aria-expanded="false" aria-controls="order__collapse_four">
                                                Do you offer ERP solutions for small businesses?
                                                <span class="accordion-btn"></span>
                                            </button>
                                        </h2>
                                    ...
                                    <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.6s" style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.6s; animation-name: fadeInUp;">
                                         <h2 class="accordion-header" id="order_five">
                                             <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#order__collapse_five" aria-expanded="false" aria-controls="order__collapse_five">
                                                Do you provide ongoing technical maintenance?
                                                 <span class="accordion-btn"></span>
                                             </button>
                                         </h2>
