                    ...
                    <div class="td-breadcrumb-title-wrap">
                        ...
                        <div class="td-breadcrumb-list wow td-animetion-right" data-wow-duration="1.5s"
                            ...
                            <ul>
                                ...
                                <li><i class="fa-sharp fa-solid fa-angle-right fa-fw"></i></li>
                                <li class="pages">Brand Activations</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="td-feature-area bg-position pt-120 pb-80" style="background: linear-gradient(135deg, #7935f9 0%, #9b5ffb 50%, #c488f9 100%);">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="td-feature-4-wrap text-center mb-50 wow fadeInUp" data-wow-duration="1.5s"
                        data-wow-delay="0.3s"
                        style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.3s; animation-name: fadeInUp;">
                        <h2 class="td-section-title text-white mb-15">Our Brand Activation Process</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="td-about-2-list mb-30">
                            <ul>
                                <li>
                                    ...
                                    <span>In-store Brand Activations</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Mall and Outdoor Promotions</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Product Sampling Campaigns</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Roadshows and Promotional Events</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    ...
                                    <span>Staffing and Brand Promoters</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Activation Setup and Branding</span>
                                </li>
                                <li>
                                    <span class="mr-15">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>Campaign Monitoring and Reporting</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="td-faq-wrapper mr-40 ml-40">
                        <div class="text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s"
                            style="visibility: visible; animation-duration: 1.5s; animation-delay: 0.3s; animation-name: fadeInUp;">
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s"
                                    ...
                                    <h2 class="accordion-header" id="order_one">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="order__collapse_one">
                                            What are brand activation services?
                                            <span class="accordion-btn"></span>
                                        </button>
                                    </h2>
                                    <div id="order__collapse_one" class="accordion-collapse collapse"
                                        aria-labelledby="order_one" data-bs-parent="#general_faqaccordion" style="">
                                        <div class="accordion-body td-faq-details-para">
                                            <p>Brand activation involves creating interactive campaigns that engage customers and promote your brand effectively.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s"
                                    ...
                                    <h2 class="accordion-header" id="order_two">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Where can brand activations be conducted?
                                            <span class="accordion-btn"></span>
                                        </button>
                                    </h2>
                                    <div id="order__collapse_two" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body td-faq-details-para">
                                            <p>They can be conducted in malls, retail stores, outdoor locations, exhibitions, and events.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s"
                                    ...
                                    <h2 class="accordion-header" id="order_three">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Do you provide promoters and staff?
                                            <span class="accordion-btn"></span>
                                        </button>
                                    </h2>
                                    <div id="order__collapse_three" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body td-faq-details-para">
                                            <p>Yes, we provide trained promoters and event staff for all activation activities.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInUp" data-wow-duration="1.5s"
                                    ...
                                    <h2 class="accordion-header" id="order_four">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Can you handle complete activation campaigns?
                                            <span class="accordion-btn"></span>
                                        </button>
                                    </h2>
