            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-8">
                    <div class="td-schedule-2-title-wrap text-center mb-40 wow fadeInUp" data-wow-duration="1.5s"
                        data-wow-delay="0.3s">
                        <!-- <span class="td-section-subtitle td-section-subtitle-2 td-section-subtitle-3  mb-30">Blog Post</span> -->
                        <h2 class="td-section-title">Creative Marketing & Branding Solutions</h2>
                        <p class="td-section-text">At Fath Creative, we combine creative thinking with strategic
                            planning to deliver effective marketing and advertising solutions. Our team works across
                            both digital and traditional platforms, offering services that range from online
                            campaigns and content creation to print media, outdoor advertising, and brand
                            activations through events and exhibitions.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="tab-pane fade active show" id="v-pills-home1" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="td-schedule-4-wrap mb-30">
                                    <div class="row gx-30">
